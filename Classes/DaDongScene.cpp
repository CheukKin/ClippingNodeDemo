...
///[5].触摸事件
	...
	listener->onTouchesBegan = CC_CALLBACK_2(DaDong::onTouchesBegan, this);
...
void DaDong::onTouchesBegan(const std::vector<Touch*>& touches, Event *unused_event)
{
...
void DaDong::pokeHoleAtPoint(Vec2 point)
{
	CCLOG("Add a Hole!!!");
